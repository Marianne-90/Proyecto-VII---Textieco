                                        ...
                                        <div class="swiper-slide product-card product-card_style3">
                                            <div class="pc__img-wrapper">
                                                <a
                                                    ...
                                                    <img loading="lazy"
                                                        src="{{asset('uploads/products')}}/{{ $product->image }}" width="258"
                    ...
                    <div class="col-md-6">
                        <div class="category-banner__item border-radius-10 mb-5">
                            ...
                            <div class="category-banner__item-content">
                                ...
                                <a href="{{ route('shop.index', ['brands' => $brand->id]) }}" class="btn-link default-underline text-uppercase fw-medium">Shop Now</a>
                            </div>
                        </div>
                    </div>
                    @endforeach
