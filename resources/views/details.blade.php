                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link nav-link_underscore" id="tab-reviews-tab" data-bs-toggle="tab"
                            href="#tab-reviews" role="tab" aria-controls="tab-reviews" aria-selected="false">Reseñas</a>
                    </li>
                </ul>
                            ...
                            <div class="swiper-slide product-card">
                                <div class="pc__img-wrapper">
                                    <a href="{{ route('shop.product.details', ['product_slug' => $rproduct->slug]) }}">
                                        ...
                                        @foreach (explode(',', $rproduct->images) as $gim)
                                            <img loading="lazy" src="{{ asset('uploads/products') }}/{{ $gim }}" width="330"
                                ...
                                <div class="pc__info position-relative">
                                    ...
                                    <div class="product-card__price d-flex">
                                        <span class="current-price"> @if ($rproduct->sale_price < $rproduct->regular_price)
